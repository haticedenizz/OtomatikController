...
namespace OtomatikController.Controllers
{
    public class AdresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ıd,KisilerId,Adres1,Sehir")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ıd,KisilerId,Adres1,Sehir")] Adres adres)
        {
            if (ModelState.IsValid)
            {
